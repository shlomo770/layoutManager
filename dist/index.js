...
function RegionSlot({ region, config, registry }) {
  ...
  return /* @__PURE__ */ jsx("section", { className: regionClassName, style: regionStyle, "data-region": region, children: /* @__PURE__ */ jsx("div", { className: "c2-slot", "data-region": region, children: /* @__PURE__ */ jsx(
    Component,
    {
      ...config.props ?? {},
...
export { C2AppShell, DEFAULT_CHROME, DEFAULT_DIRECTION, RegionSlot, buildThemeVars, computeGridTemplate, defineLayoutConfig, regionPlacement, resolveDirection, toFlexValue };
